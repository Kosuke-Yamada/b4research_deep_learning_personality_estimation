...
READ_TRAIN_TWEET_FILE = "../DATA/09.DATASET_TDT/train_tweet_word_count.json"
TRAIN_LIST = [READ_TRAIN_MBTI_FILE, READ_TRAIN_TWEET_FILE]
READ_DEV_MBTI_FILE = "../DATA/09.DATASET_TDT/dev_mbti.json"
READ_DEV_TWEET_FILE = "../DATA/09.DATASET_TDT/dev_tweet_word_count.json"
DEV_LIST = [READ_DEV_MBTI_FILE, READ_DEV_TWEET_FILE]

WRITE_DIR = "../DATA/11.MODEL2/"
