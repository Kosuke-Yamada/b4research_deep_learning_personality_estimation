...
READ_MODEL_FILE = "../DATA/11.MODEL1/save_model/"+str(MBTI)+"_"+str(NUM).zfill(2)+".json"
READ_WEIGHT_BEST_FILE = "../DATA/11.MODEL1/best_weight/"+str(MBTI)+"_"+str(NUM).zfill(2)+".hdf5"

WRITE_ROC_PICTURE_FILE = "../DATA/11.MODEL1/test_roc_picture/"+str(MBTI)+"_"+str(NUM).zfill(2)+".png"
